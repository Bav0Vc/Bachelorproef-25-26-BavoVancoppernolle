...
\begin{itemize}
    ...
    \item \textbf{ground\_truth:} Het ideale antwoord, dat manueel geverifieerd is. Dit dient als referentie om de \textit{faithfulness} en \textit{answer correctness} van de \gls{llm} te meten.
