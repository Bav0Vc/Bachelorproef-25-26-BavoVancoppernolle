...
De dataset die voor dit onderzoek wordt gebruikt, is ter beschikking gesteld door Turtle Srl Deze verzameling bevat een variëteit aan documenten die representatief zijn voor de informatiehuishouding van een productiebedrijf in het kader van \gls{esg}-rapportage.
...
\end{minted}
\caption{Exacte \gls{json}-structuur van de golden dataset}
