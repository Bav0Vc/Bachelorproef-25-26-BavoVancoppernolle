...
De nood is primair gedreven door de Europese \gls{csrd}, die bedrijven zoals Turtle S.r.l. verplicht om te rapporteren over milieu-, sociale en governanceaspecten conform de \gls{esrs}-standaarden. Aanvullend vereisen klanten en stakeholders via EcoVadis- en \gls{vsme}-vragenlijsten een transparante verantwoording van duurzaamheidsprestaties.

\textit{Welke structurele en juridische uitdagingen zijn er bij het beantwoorden van \gls{esg}-vragenlijsten?}
\gls{esg}-informatie is bij Turtle S.r.l. verspreid over heterogene documenten in meerdere formaten (\texttt{.pdf}, \texttt{.docx}, \texttt{.xlsx}) en talen (Italiaans en Engels). Het handmatig lokaliseren, extraheren en verifiëren van de relevante datapunten is tijdsintensief, foutgevoelig en moeilijk auditeerbaar. De wettelijke traceerbaarheidseis — elke bewering moet herleidbaar zijn tot een exact brondocument en paginanummer — versterkt de nood aan een geautomatiseerde oplossing.
...
\paragraph{Het LLM als minst bepalende factor.}
...
De data-soevereiniteits- en \gls{gdpr}-eis die de platformkeuze aanstuurt (Sectie~\ref{ch:requirementsanalyse}), alsmede de Cloud Act-overwegingen die de \gls{llm}-selectie mede bepaalden (Sectie~\ref{sec:shortlist-llm}), vormen een aandachtspunt voor de productierol van de \gls{poc} op Microsoft Azure. Een mogelijke mitigatie is een anonymiseringsstap in de preprocessing-pipeline die persoonsgegevens en commercieel gevoelige informatie maskeert vóór ingestie in de vector database. De ontwikkeling en validatie van een dergelijke anonimiseringsmodule valt buiten de scope van dit onderzoek en vormt een relevant vervolgtraject.
