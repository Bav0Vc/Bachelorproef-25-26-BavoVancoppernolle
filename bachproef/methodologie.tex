...
Via bijkomende interviews met belanghebbenden wordt bepaald welke documenten nodig zijn om een dataset te verkrijgen die bruikbaar is voor ESG rapportage. Deze data kan bestaan uit jaarverslagen, duurzaamheidsrapporten, (energie)facturen, beleidsdocumenten of interne richtlijnen. Indien nodig worden documenten geanonimiseerd voordat ze in de experimentele omgeving worden opgenomen om de veiligheid van de data te verzekeren.

Daarnaast wordt een golden set van vragen opgesteld, die ESG-gerelateerde vragen zoals questionnaires van Ecovadis en VSME omvat. Voor elke vraag wordt waar mogelijk een referentie antwoord, bijbehorende brondocumenten en relevante pagina  of sectienummers vastgelegd. Deze metadata maakt het mogelijk om zowel automatische evaluatie, met RAGAS, als handmatige expert evaluatie (bijvoorbeeld audits) uit te voeren.
