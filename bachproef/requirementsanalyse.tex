...
\begin{itemize}
  ...
  \item \textbf{Operationele efficiëntie (latency/performantie).} De responstijd en de scores op de \gls{ragas} metrics moeten per configuratie gemonitord worden. Een technisch optimale configuratie die in de praktijk te traag is of ondermaats scoort, heeft geen business value voor Turtle Srl.
...
\begin{table}[h]
  ...
  \begin{tabular}{p{0.04\textwidth} p{0.06\textwidth} p{0.33\textwidth} p{0.48\textwidth}}
    ...
    S & NFR & Operationele efficiëntie (latency/kosten)    & De balans tussen snelheid en token-kosten moet een rendabele businesscase mogelijk maken. \\
