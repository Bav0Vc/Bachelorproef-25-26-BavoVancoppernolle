...
Een bijzonderheid van de implementatie is de \texttt{max\_length}-parameter. Deze wordt namelijk in de indexeringspipeline geïnitialiseerd op basis van het geselecteerde \gls{llm} voor die indexeringsrun. Dit wordt verder toegelicht in Sectie~\ref{sec:technische-uitvoering-chunking} over chunk-optimalisatie.
