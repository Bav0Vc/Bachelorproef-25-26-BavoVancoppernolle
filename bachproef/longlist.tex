...
\begin{itemize}
  ...
  \item \textbf{Open-source (OS):} Beschikbaarheid van de modelparameters (\textit{OW}) open weight voor lokale implementatie, wat volledige controle over de dataverwerking mogelijk maakt.
  \item \textbf{Native hybride (embedding \& retrieval):} Het model ondersteunt zowel semantische (dense) als lexicale (sparse) embedding en zoekopdrachten.
...
Nomic Embed-Text-V1.5              & 34.09\% & 2 & Nee & Ja  & Nee & 8192 \\ % Niet meertalig
\bottomrule
\end{tabular}
...
\midrule
Mistral Small 4 (2603)  & 73.5\% & ?      & 256  & Open Weights & 0 \\
Meta Llama 3.3 70B      & 86.0\% & 92.1\% & 128k & Open Weights & 1 \\
Google Gemma 3 27B IT   & 76.9\% & 90.4\% & 128k & Open Weights & 1 \\
GPT-4o (OpenAI)         & 81.4\% & 81.0\% & 128k & Proprietary  & 2 \\
DeepSeek-V3             & 88.5\% & 86.1\% & 128k & Open Weights & 3 \\
\bottomrule
\end{tabular}
